...
class NullInversion:
    ...
    def image2latent(self, image):
        with torch.no_grad():
            ...
            if type(image) is torch.Tensor and image.dim() == 4:
                ...
                image = torch.from_numpy(image).float() / 0.5 - 1
    ...
    def init_prompt(self, prompt: str):
        ...
        # uncond_embeddings = self.model.text_encoder_list[0](uncond_input.input_ids.to(self.model.device))[0] # auffusion-full
        ...
        # text_embeddings = self.model.text_encoder_list[0](text_input.input_ids.to(self.model.device))[0] # auffusion-full
    ...
    def null_optimization(self, latents, num_inner_steps, epsilon):
        ...
        for i in range(NUM_DDIM_STEPS):
            ...
            optimizer = Adam([uncond_embeddings], lr=1e-4 * (1. - i / 1000.))
    ...
    def __init__(self, model):
        ...
        self.model = model
        # self.tokenizer = self.model.tokenizer_list[0] # auffusion-full
