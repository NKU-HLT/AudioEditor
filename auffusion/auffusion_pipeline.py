...
from prompt2prompt.attn_control import AttentionStore
...
class AuffusionPipeline(DiffusionPipeline):
    ...
    def from_pretrained(
        ...
        for i, condition_item in enumerate(condition_json_list):
            ...
            # tokenizer = AutoTokenizer.from_pretrained(pretrained_model_name_or_path, subfolder=condition_item["text_encoder_name"])
            ...
            # adapter = ConditionAdapter.from_pretrained(pretrained_model_name_or_path, subfolder=condition_item["condition_adapter_name"]).to(device, dtype)
